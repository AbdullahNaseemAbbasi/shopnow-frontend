...
import { Heart, ShoppingCart, Trash2, BellRing } from 'lucide-react';
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {items.some(i => !i.inStock) ? (
          <p className="text-sm text-gray-500 mb-6 flex items-center gap-1.5">
            <BellRing size={14} className="text-brand" /> We&apos;ll notify you the moment an out-of-stock item here is back.
          </p>
        ) : (
          <div className="mb-6" />
        )}
