  ...
  const Sidebar = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-800">
        ...
        <button onClick={handleLogout} className="flex items-center gap-2 w-full px-4 py-2.5 rounded-xl text-red-400 hover:bg-gray-800 text-sm font-semibold transition-colors">
