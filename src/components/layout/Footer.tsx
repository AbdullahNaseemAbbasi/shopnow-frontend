  ...
  return (
    <footer className="bg-slate-900 text-slate-300">
      ...
      <div className="border-b border-slate-800">
        <div className="max-w-[1600px] mx-auto px-8 py-8 flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+923001234567" className="text-sm text-slate-400 hover:text-brand-400 transition-colors">0300-1234567</a>
              </li>
              <li className="flex items-center gap-3">
